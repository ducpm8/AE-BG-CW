...
public class Recaptcha
{
	...
	public String getPixel(String filename) throws InterruptedException
    {
		String captchaR = "";
    	...
    	String username = "jimmorrison";
        String password = "DucPham1989";
        ...
        try {
            ...
            try {
            	...
            	captcha = client.decode(filename, 120);
            ...
            if (null != captcha) {
                ...
                captchaR = captcha.text;
//                String vectorsss = captcha.text;
//                
//            	String vectors[] = vectorsss.split(",");
//            	
//            	
//            	for (int h=0; h<vectors.length; h++) {
//            		pixel.add(Integer.valueOf(vectors[h].replaceAll( "[^\\d]", "" )));
//            	}
